...
class AddNewParkingTest {
	...
	void addNewParkingAreaTest() throws DuplicateEntryException {
		...
		assertEquals("aditya", addNewParking.createNewParking("aditya", 10).getName());
		assertEquals(10, addNewParking.createNewParking("aditya", 10).getMaxslots());
	}
